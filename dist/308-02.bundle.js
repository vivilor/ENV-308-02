  ...
  methods: {
    ...
    animateRiverElement($el) {
      return __WEBPACK_IMPORTED_MODULE_2_animejs___default()({
        ...
        translateY: [
          {
            value: -__WEBPACK_IMPORTED_MODULE_1__config_json___default.a.elements.oscillationOffset,
            easing: "easeInOutSine",
            duration: __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.elements.T / (10 + this.randomize(20)),
          }
        ]
      })
    },
    ...
    animateRiverElementsHide() {
      $(`.${this.classes.wrap}`).fadeOut(
        __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.finishDuration,
      ...
      __WEBPACK_IMPORTED_MODULE_2_animejs___default()({
        ...
        complete: () => {
          ...
          if (this.answer.step < this.content.correct.length) {
            ...
            this.eventBus.$emit(__WEBPACK_IMPORTED_MODULE_0__events__["a" /* default */].step.change, 3);
          }
    ...
    animateHelper($el, position) {
      ...
      __WEBPACK_IMPORTED_MODULE_2_animejs___default()({
        ...
        opacity: [
          {
            value: 1,
            duration: __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.fallDuration
          },
          {
            value: 0,
            duration: __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.swimDuration,
            easing: "easeInCirc"
          }
        ],
        ...
        complete: () => {
          ...
          __WEBPACK_IMPORTED_MODULE_2_animejs___default()({
            ...
            opacity: [
              {
                value: 0,
                duration: __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.swimDuration / 2
              },
              {
                value: 1,
                duration: __WEBPACK_IMPORTED_MODULE_1__config_json___default.a.swimDuration / 2,
...
var render = function() {
  ...
  return _c(
    ...
    {
      attrs: { name: "wrapper" },
      on: { "after-enter": _vm.afterWrapperEnter }
    },
    [
      _c(
        "div",
        ...
        [
          _c(
            ...
            {
              attrs: { name: "answers" },
              on: { "after-enter": _vm.afterAnswersEnter }
            },
            [
              _c(
                "div",
          ...
          _c("div", {
            style: "width: " + _vm.cache.riverWidth + "px",
